...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        *,
        ...
        self._extract_into_tensor=_extract_into_tensor
    ...
    def p_mean_variance(self, model, x, t, clip_denoised=True, denoised_fn=None, model_kwargs=None):
        ...
        #     )
            ...
            pred_xstart = process_xstart(
                self._predict_xstart_from_v(x_t=x, t=t, v=model_output.squeeze(1))
            )
    ...
    def _predict_xstart_from_v(self, x_t, t, v):
        ...
        return (
            _extract_into_tensor(self.sqrt_alphas_cumprod, t, t.shape).unsqueeze(-1) * x_t
            - _extract_into_tensor(self.sqrt_one_minus_alphas_cumprod, t, t.shape).unsqueeze(-1) * v
        )
